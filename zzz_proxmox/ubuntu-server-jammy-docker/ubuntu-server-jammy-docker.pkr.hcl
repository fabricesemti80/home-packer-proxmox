...
source "proxmox-iso" "ubuntu-server-jammy" {
    ...
    # VM OS Settings
    boot_iso {
        iso_file = "nfs-qnap-proxmox:iso/ubuntu-22.04.1-live-server-amd64.iso"
        iso_storage_pool = "nfs-qnap-proxmox"
        unmount = true
    }
    ...
    http_bind_address = "10.0.40.199" # "0.0.0.0" # ? ip from ifconfig
    http_port_min = 8802
    http_port_max = 8802
